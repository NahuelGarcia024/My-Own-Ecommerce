...
const LoginPage = () => {
    ...
    const setToken = useAuthStore((state) => state.setToken);  ///setting tokens for auths
          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}> 
              ...
              <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                No tenes una cuenta?<Link to={'/register'} className="font-medium text-primary-600 hover:underline dark:text-primary-500"><span> Registrarse</span></Link>
              </p>
            </form>
          </div>
        </div>
