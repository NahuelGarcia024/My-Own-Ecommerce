...
import { useMutation, useQuery, useQueryClient } from "@tanstack/react-query"; //validacion de query y mutation para hacer post y request
...
// para saber como estamos posicionados en el drag and drop de la imagen
